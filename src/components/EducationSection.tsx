...
const educationData: EducationEntry[] = [
    {
        ...
        bullets: [
            "Current CGPA: 8.01",
            "Focused on software development, data structures, algorithms, and cloud technologies",
    ...
    },
    {
        ...
        location: "Ichalkaranji, India",
        bullets: [
            "Completed with 85.20%",
            "Strong fundamentals in mathematics, science, and language",
